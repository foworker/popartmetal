...
export default function Home() {
	...
	return (
		<>
			<Head>
				<title>PopArt Metal</title>
				<meta name="description" content="PopArt Metal Aksesuar Sanayi Ltd.Şti." />
			</Head>
			<section className="mb-6 mt-3 overflow-hidden rounded-3xl bg-blue-100">
				<SlickSlider />
			</section>
			<section className="mt-8 flex justify-between gap-10">
				<div className="w-1/2">
			...
			<section className="mt-8 flex justify-between gap-10">
				...
				<div className="w-1/2">
					<Image alt="PopArt Metal 2" src={image2} layout="responsive" objectFit="cover" />
				</div>
			</section>
		</>
	);
