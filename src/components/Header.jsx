				...
				<div className="container mx-auto flex h-9 items-center justify-between align-middle text-sm text-white">
					<div className="flex">
						...
						<Link href="https://api.whatsapp.com/send?phone=+905061449973">
							<a className="flex">
								<svg xmlns="http://www.w3.org/2000/svg" className="mr-1" width="18" height="18" viewBox="0 0 24 24" strokeWidth="2" stroke="#25d366" fill="none" strokeLinecap="round" strokeLinejoin="round">
									<path stroke="none" d="M0 0h24v24H0z" fill="none" />
